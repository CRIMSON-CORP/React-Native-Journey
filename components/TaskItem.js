...
const TaskItem = (props) => {
    ...
    const highlightColor = themeTools.getColor(theme, "blue.500");
    const boxStroke = themeTools.getColor(theme, "muted.500");
    const checkmarkColor = themeTools.getColor(theme, "white");
    const activeTextColor = themeTools.getColor(theme, "darkText");
    const doneTextColor = themeTools.getColor(theme, "muted.400");
